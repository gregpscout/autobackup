...
pybot -i JOBCREATION --output tbe_create.xml --report tbe_create.html ../src/features/tbe/
...
rebot --outputdir bh_smoke tbe_create.xml bh_import.xml tbe_links.xml tbe_bh_accept.xml tbe_bh_reject.xml bh_links.xml bh_placement.xml
...
rebot --outputdir pcr_smoke pcr_import.xml pcr_sub.xml pcr_links.xml tbe_pcr_accept.xml tbe_pcr_reject.xml pcr_placement.xml pcr_clean.xml
