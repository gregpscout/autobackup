...
res = os.system('ssh -i /Users/djangal/.ssh/yzhaotalentdrive.pem ubuntu@qa01.talentfilter.biz "%s" ' % mkdir_cmd)
res2 = os.system('scp -i /Users/djangal/.ssh/yzhaotalentdrive.pem %s/* ubuntu@qa01.talentfilter.biz:%s' %(inDir, remote_report_dir))